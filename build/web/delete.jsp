<%-- 
    Document   : delete
    Created on : 8 Mar, 2020, 1:32:45 PM
    Author     : Lenovo
--%>
...
<html>
    <head>
        ...
        <title>user file Delete page</title>
        <style>
.button {
  border-radius: 4px;
...
.button:hover span:after {
  ...
  right: 0;
    ...
    <center>
            <form name="form1" method="post" action="remove">
         <br>
           </br>
           <table width="" border="0">
                <tr>
                    <td>
                        <div align="center">
                            <font size="10" face="Lucida Calligraphy">File Revocation Page</font></div>
                    </td>
                </tr>
            </table>
           <p>
       ...
       <div align="center"><font size="4" face="Californian FB" color="#ffffff">
            <h1>Your File List Here</h1></font>
        </div>
        <center>
        <table width="250" border="0">
           ...
           String qry="select filename from ownerprofile";
