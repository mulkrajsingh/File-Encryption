...
<div class="login-form-1">
	...
	<form action="UserRegistrationForm" id="" name="" method="post">
		<input type="text" id ="username" name="username" class="text"  placeholder="Enter User Name" required="required">
                <input type="password" id ="password"  name="password" placeholder="Enter your Password" required="required" >
                <input type="text" id ="gender"  name="gender" placeholder="Enter your gender" required="required" >
                
                
                
                
		<input type="text" id ="email"class="text" name="email" placeholder="Enter your email" required="required"   >
		<input type="text" id ="mobile"class="text" name="phoneno"  placeholder="Enter your MobileNo" required="required">
                <input type="text" id ="username" name="userproductkey" class="text"  placeholder="Enter your Key " required="required" >
